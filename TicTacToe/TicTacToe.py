...
root = GetRoot("TicTacToe by Uday", "200x210", image_path=(edpath + "ShortCode/Data/SCUI.png"))
...
while submitted == False:
    ...
    root = GetRoot("TicTacToe by Uday", "200x250", image_path=(edpath + "ShortCode/Data/SCUI.png"))
    root.resizable(False, False)
    out = None
